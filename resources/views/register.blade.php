...
<body class="bg-[#f7f4ec] min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-[550px] border border-[#72302b] rounded-xl px-6 py-10 sm:px-12 sm:py-12 bg-[#f7f4ec]">
        ...
        <form method="POST" action="{{ route('register.submit') }}" class="space-y-4">
            ...
            <button 
                type="submit" 
                class="w-full bg-[#72302b] text-white py-3 rounded-md hover:bg-[#5a2522] transition duration-200 text-sm font-medium mt-4"
            >
                Create Account
            </button>
        </form>
        ...
        <div class="mt-10 flex items-center justify-start gap-4">
            ...
            <div class="flex flex-col">
                ...
                <a href="{{ route('login') }}" class="font-bold text-[#72302b] text-[15px] underline decoration-1 underline-offset-[3px] hover:text-[#5a2522]">Login to Account</a>
            </div>
        </div>
